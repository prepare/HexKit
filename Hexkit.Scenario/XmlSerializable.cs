...
namespace Hexkit.Scenario {
    ...
    /// (internal or protected) level of visibility for XML serialization tasks.
    /// </para><para>
    ...
    /// <see cref="FilePaths.ScenarioSchema"/>.</item></list></remarks>
    ...
    public abstract class XmlSerializable {
        ...
        /// cref="FilePaths.ScenarioSchema"/> that is expected by <see cref="ReadXml"/> and created
        ...
        /// is assumed to conform to <see cref="FilePaths.ScenarioSchema"/>.
        /// </para><para>
        ...
        /// cref="FilePaths.ScenarioSchema"/>. <b>ReadXmlAttributes</b> does not check the element
        ...
        /// cref="FilePaths.ScenarioSchema"/>. <b>ReadXmlElements</b> reads only the first XML
        ...
        /// <see cref="FilePaths.ScenarioSchema"/> defines an XML representation to the specified
        ...
        /// for which <see cref="FilePaths.ScenarioSchema"/> defines an XML attribute to the
        /// specified <paramref name="writer"/>.
        /// </para><para>
        /// The resulting data stream is an XML fragment which conforms to the attributes of the XML
        /// element named <see cref="XmlName"/> defined in <b>ScenarioSchema</b>.
        /// </para><para>
        ...
        /// which <see cref="FilePaths.ScenarioSchema"/> defines a nested XML element to the
        /// specified <paramref name="writer"/>.
        /// </para><para>
        /// The resulting data stream is an XML fragment which conforms to the nested element tags
        /// of the XML element named <see cref="XmlName"/> defined in <b>ScenarioSchema</b>.
        /// </para><para>
