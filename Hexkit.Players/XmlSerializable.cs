...
namespace Hexkit.Players {
    ...
    /// cref="FilePaths.SessionSchema"/>.</summary>
    /// <remarks><para>
    ...
    /// Class <see cref="PlayerManager"/> still implements the interface <see
    /// cref="IXmlSerializable"/> because its serialization is controlled by class <b>Session</b> in
    /// assembly <b>Hexkit.Game</b>.
    /// </note><para>
    ...
    public abstract class XmlSerializable {
        ...
        /// An error occurred while parsing the XML data provided by <paramref
        ...
        /// is assumed to conform to <see cref="FilePaths.SessionSchema"/>.
        /// </para><para>
        ...
        /// overridden by derived classes to read any desired object data.</para></remarks>
        ...
        /// cref="FilePaths.SessionSchema"/>. <b>ReadXmlAttributes</b> does not check the element
        ...
        /// cref="FilePaths.SessionSchema"/>. <b>ReadXmlElements</b> reads only the first XML
        ...
        /// overridden by derived classes to write any desired object data.</para></remarks>
        ...
        /// for which <see cref="FilePaths.SessionSchema"/> defines an XML attribute to the
        /// specified <paramref name="writer"/>.
        /// </para><para>
        /// The resulting data stream is an XML fragment which conforms to the attributes of the XML
        /// element named <see cref="XmlName"/> defined in <b>SessionSchema</b>.
        /// </para><para>
        ...
        /// which <see cref="FilePaths.SessionSchema"/> defines a nested XML element to the
        /// specified <paramref name="writer"/>.
        /// </para><para>
        /// The resulting data stream is an XML fragment which conforms to the nested element tags
        /// of the XML element named <see cref="XmlName"/> defined in <b>SessionSchema</b>.
        /// </para><para>
