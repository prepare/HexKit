...
namespace Hexkit.World.Instructions {
    ...
    /// <summary>
    /// Represents an instruction that takes a <see cref="String"/> parameter and a <see
    /// cref="Boolean"/> parameter.</summary>
    /// <remarks><para>
    /// <b>StringBooleanInstruction</b> adds the <see cref="StringBooleanInstruction.Value"/>
    ...
    /// </para><para>
    /// <b>StringBooleanInstruction</b> corresponds to the complex XML type
    /// "stringBooleanInstruction" defined in <see cref="FilePaths.SessionSchema"/>.
    /// </para></remarks>

    public abstract class StringBooleanInstruction: StringInstruction {
        #region StringBooleanInstruction()

        /// <overloads>
        /// Initializes a new instance of the <see cref="StringBooleanInstruction"/> class.
        /// </overloads>
        /// <summary>
        /// Initializes a new instance of the <see cref="StringBooleanInstruction"/> class with
        /// default properties.</summary>

        protected StringBooleanInstruction(): base() { }

        #endregion
        #region StringBooleanInstruction(String, String, Boolean)

        /// <summary>
        /// Initializes a new instance of the <see cref="StringBooleanInstruction"/> class with the
        /// specified identifier, <see cref="String"/> value, and <see cref="Boolean"/> value.
        /// </summary>
        /// <param name="id">
        ...
        protected StringBooleanInstruction(string id, string text, bool value): base(id, text) {
            this._value = value;
        }
        ...
        /// </summary>
        /// <value>
        /// The <see cref="Boolean"/> value associated with the <see
        /// cref="StringBooleanInstruction"/>. The default is <c>false</c>.</value>
        /// <remarks>
        ...
        /// <summary>
        /// Reads XML attribute data into the <see cref="StringBooleanInstruction"/> object using
        ...
        protected override void ReadXmlAttributes(XmlReader reader) {
            ...
            XmlUtility.ReadAttributeAsBoolean(reader, "value", ref this._value);
        }
        ...
        /// <summary>
        /// Writes all current data of the <see cref="StringBooleanInstruction"/> object that is
