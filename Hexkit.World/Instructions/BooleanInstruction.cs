...
namespace Hexkit.World.Instructions {
    ...
    /// <summary>
    /// Represents an instruction that takes a <see cref="Boolean"/> parameter.</summary>
    /// <remarks><para>
    /// <b>BooleanInstruction</b> adds the <see cref="BooleanInstruction.Value"/> instruction
    ...
    /// </para><para>
    /// <b>BooleanInstruction</b> corresponds to the the complex XML type "booleanInstruction"
    /// defined in <see cref="FilePaths.SessionSchema"/>.</para></remarks>

    public abstract class BooleanInstruction: Instruction {
        #region BooleanInstruction()

        /// <overloads>
        /// Initializes a new instance of the <see cref="BooleanInstruction"/> class.</overloads>
        /// <summary>
        /// Initializes a new instance of the <see cref="BooleanInstruction"/> class with default
        /// properties.</summary>

        protected BooleanInstruction(): base() { }

        #endregion
        #region BooleanInstruction(String, Boolean)

        /// <summary>
        /// Initializes a new instance of the <see cref="BooleanInstruction"/> class with the
        /// specified identifier and <see cref="Boolean"/> value.</summary>
        /// <param name="id">
        /// The initial value for the <see cref="Instruction.Id"/> property.</param>
        /// <param name="value">
        /// The initial value for the <see cref="Value"/> property.</param>

        protected BooleanInstruction(string id, bool value): base(id) {
            this._value = value;
        }
        ...
        /// <summary>
        /// Gets the <see cref="Boolean"/> value associated with the <see cref="Instruction"/>.
        /// </summary>
        /// <value>
        /// The <see cref="Boolean"/> value associated with this <see cref="BooleanInstruction"/>.
        ...
        /// <summary>
        /// Reads XML attribute data into the <see cref="BooleanInstruction"/> object using the
        ...
        /// <summary>
        /// Writes all current data of the <see cref="BooleanInstruction"/> object that is
