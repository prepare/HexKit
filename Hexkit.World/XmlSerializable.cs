...
namespace Hexkit.World {
    ...
    /// (internal or protected) visibility for XML serialization tasks.
    /// </para><note type="implementnotes">
    /// Class <see cref="History"/> still implements the interface <see cref="IXmlSerializable"/>
    /// because its serialization is controlled by class <b>Session</b> in assembly
    /// <b>Hexkit.Game</b>.
    /// </note><para>
